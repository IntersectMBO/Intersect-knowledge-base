...
* 👉 **Intersect Governance Decision Making Process –** [**Full Document**](https://docs.google.com/document/d/1gMwK5EiJuGa9_ToMSEgzlYY9r8bSzLXfwV0A0xj98QU/edit?tab=t.0#heading=h.vsvixt5eqtu0)\
  Narrative explainer that walks through each step of the process and clarifies roles, impact levels, and exception paths.
* 👉 [**Timeframe & SLA Guidance Document**](https://docs.google.com/document/d/1wzLf9K36FylFKm4b5i5G9DPOWklIh1qQWEfdNqghCTs/edit?tab=t.0#heading=h.hszkt6c2op6w)\
  Companion document that suggests expected durations (SLAs) for each stage in the decision process — from proposal intake to execution — helping track responsiveness and accountability.
...
<figure><img src="../../../.gitbook/assets/Intersect Governance WG.jpg" alt=""><figcaption></figcaption></figure>
