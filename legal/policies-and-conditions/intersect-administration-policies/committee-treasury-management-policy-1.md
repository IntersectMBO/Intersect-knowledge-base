# Committee Treasury Management Policy

**1. Policy Title:** Committee Treasury Management Policy

**2. Version:** 1.0

**3. Effective Date:** 15th August 2025
...
* **Conflict of Interest:** A conflict of interest arises when an individual’s personal, professional, or financial interests interfere, or appear to interfere, with the interests of the Committee.
...
* **Master Services Agreement (MSA):** A contract that sets the general terms and conditions for an ongoing business relationship, so future projects or services can be added easily without renegotiating the basic rules each time.
...
* **Program-Specific Contracts:** For individual programs, the process is as follows:
  * **Monthly planning:** Committee Secretary aligns with Intersect Finance, Procurement team and Operations lead on upcoming programs in the month. This allows Procurement and Operational teams to align on planning and contract template readiness.
  *   **Vendor Approval**: In line with the programs of work stipulated in the Master Contract, the Committee can run the approval for a vendor in several ways:

      * **Running an RFP/Grant:** Follow the [Intersect RFP/Grant guidelines](https://docs.intersectmbo.org/cardano-facilitation-services/cardano-budget/intersect-administration-services/2025-apply-for-tender) to solicit bids.
      * **Directly selecting a vendor:** This is only permitted if the vendor is the only one in the ecosystem with the necessary skills to fulfill the contract and justification must be provided to Intersect Procurement team

      In either case, the chosen vendor must be approved by a vote from the Committee members. If an RFP/Grant was used, the Intersect Operations lead will oversee the process. If a vendor is chosen without an RFP/Grant, the Committee must provide a justification which may be shared with the Community, explaining why this to be the case (e.g. the vendor being the only one with the necessary skills to do the job.)
  * **Information Handover:** Once the designated vendor has been agreed by the Committee following a fair, transparent selection process, the Committee secretary provides the vendor's name, contract details, budget and scope of work to the Intersect procurement team, via the Committee Procurement Request Form on Clickup. This needs to evidence formal sign off via the Committee by sharing evidence of when the decision was made.
...
* **Handover Authority**: Ensures responsibility for the MSA (Master Services Agreement) and SoW (Statement of Work) is transferred to the procurement team, including proof of Committee sign-off. This includes sharing the chosen vendor's name, contract details, budget and scope of work to the Intersect procurement team. This must be submitted by the Secretary through the Committee Procurement Request Form on Clickup.
* **Support Role:** Assists Operations lead during the RFP/Grant process (if required), ensuring alignment with Committee direction.
* **Contract Management:** Supports the ongoing delivery and management of the contract alongside the Delivery Assurance (DA) team.
* **Delivery Assurance:** Responsible for all required reporting as part of the larger milestone reporting process.
* **Milestone Acceptance:** Responsible for completing and submitting the Milestone Acceptance Forms for the Master Contract.
* **Conflict of Interest:** Notify the Procurement and Legal teams of any conflict of interest declarations made by Committee members.
...
* **Responsibility:** Liaise with Committee secretary who in turn liaises with the subcontractors for the reporting and completion of milestones.
* **Approval Authority:** Ensure all milestones comply with the agreed contract terms.

**Finance Team**

* **Responsibility**: Receive all contract payment details and schedules, and process payments. Track forecasted and current spend across Committee budgets.
* **Approval Authority:** Ensure all payments comply with the agreed contract terms.

**Intersect Executive Director (Authorised Signatory)**
...
* **Cardano governance and policy documents**
  ...
  * [Delivery Assurance Process and Best Practice Policy](https://docs.intersectmbo.org/legal/policies-and-conditions/intersect-administration-policies/delivery-assurance-process-and-best-practice-policy)
  ...
  * [Technical Review Policy](https://docs.intersectmbo.org/legal/policies-and-conditions/intersect-administration-policies/technical-review-policy)
