...
4. OR The Cardano Signer tool for those preferring a non-browser extension method:[ https://github.com/gitmachtl/cardano-signer](https://github.com/gitmachtl/cardano-signer)
...
5. Authorize: Follow the prompts to sign.
6. Browser Wallet: A popup will ask for a signature.
7. Cardano Signer: Follow the on-screen instructions to sign the required data payload.
8. Confirm: This step validates your DRep ID. Note: This does not create a transaction; it only proves ownership.
