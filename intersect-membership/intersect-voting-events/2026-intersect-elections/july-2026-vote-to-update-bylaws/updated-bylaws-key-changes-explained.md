---
description: >-
  The proposed update introduces several improvements designed to increase
  clarity, consistency, and operational effectiveness, providing a foundation
  for every election, member vote, committee process
---

# Updated ByLaws - Key Changes Explained

{% hint style="info" %}
## Updated ByLaws full text

Review the full text [here](updated-bylaws-full-text.md)
{% endhint %}

<details open>

<summary><strong>1. General changes to ensure compliance with Wyoming Law</strong></summary>
...
The new ByLaws are easier to consult, as they are now consolidated in one document, and also fully aligned to latest Wyoming legislation contextualised to Intersect MBO operations.

</details>

<details>

<summary><strong>2. Voting Rights and Requirements</strong></summary>
...
Reinforcing the One-Member-One-Vote principle, alongside the clarified thresholds, provide further support as well as protection for all future voting events in the MBO, as well as ensuring that Intersect remains compliant with Wyoming Law.<br>

</details>

<details>

<summary><strong>3. One Person, One Membership</strong></summary>
...
This reinforces the core One-Member-One-Vote principle, providing extra clarity to members and committees and also providing extra protection for any future voting event.

</details>

<details>

<summary><strong>4. Board Size and Terms, and Board elections</strong></summary>
...
The new ByLaws now accurately reflect the structure that members have already approved and are familiar with. They also provide more precise guidance for how to manage the Board and their elections, giving a clearer framework to the Intersect Steering Committee, and members overall, on how to define future detailed policies.

</details>

<details>

<summary><strong>5. Executive Director ability to protect Intersect’s governance</strong></summary>
...
<summary><strong>6. Annual Member Meeting (AMM)</strong></summary>
...
Members will have greater transparency and a more consistent process for participating in key organizational meetings.
