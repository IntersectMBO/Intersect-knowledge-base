...
* Have maintained good standing membership for **at least 180 days** _(6 months)_ before voting starts.
* Have completed **enhanced KYC verification** before voting ends.
* Have **participated as a voter in at least one previous vote** via the Intersect Member Area _(this could include any election such as committee elections, board elections, and chair elections)_
