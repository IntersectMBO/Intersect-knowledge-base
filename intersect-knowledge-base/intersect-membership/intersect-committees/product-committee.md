...
The Product committee facilitates the processes that help the Cardano community create a vision and a strategy.

## Which topics does this committee cover?

The Product committee covers topics such as roadmap, focusing on the 'why' and the related strategy, long-term vision and broader user/customer needs.

## How to join?

Any member of Intersect can run for election to assume a voting seat, and any member or associate of Intersect can connect to the Product committee via the Intersect discord server. Intersect always communicates details on how to apply and vote well in advance of each election.
