# Contributing to the Intersect Knowledge Base documentation

## Table of Contents

- [Contributing to the Intersect Knowledge Base documentation](#contributing-to-the-intersect-knowledge-base)
...
1. **Fork the repository:**
   - Navigate to  https://github.com/IntersectMBO/intersect-knowledge-base
...
2. **Clone the fork:**
   ...
   - Run the following command to clone the repository:
     ```shell
     git clone https://github.com/IntersectMBO/intersect-knowledge-base.git
     ```

3. **Navigate to the Project Directory:**
   - After cloning, change into the project's root directory:
     ```shell
     cd intersect-knowledge-base
     ```
